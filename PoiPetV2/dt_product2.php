...
<head>
    ...
    <title>SAMBA JUVENTUS - PoiPet Shop</title>
...
<div class="small-container single-product">
    <div class="row sp_row">
        <div class="col-2">
            <img src="images/male/02SAMBA JUVENTUS/SAMBA JUVENTUS1.png" width="100%" id="ProductImg">
            <div class="small-img-row">
                <div class="small-img-col">
                    <img src="images/male/02SAMBA JUVENTUS/SAMBA JUVENTUS1.png" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/male/02SAMBA JUVENTUS/SAMBA JUVENTUS2.png" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/male/02SAMBA JUVENTUS/SAMBA JUVENTUS3.png" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/male/02SAMBA JUVENTUS/SAMBA JUVENTUS4.png" width="100%" class="small-img">
                </div>
            </div>
        </div>
        <div class="col-2">
            <h1>SAMBA JUVENTUS</h1>
            <h4>$129.00</h4>
            ...
            <br>
            <p>CLASSIC SAMBA SHOES IN JUVENTUS' HOME COLOURS.<br>Show you roll with Italian super-club style. Pull on these adidas Samba Team shoes done up in Juventus' world-famous black-and-white colours and with a proud display of the Turin club's distinctive badge on the tongue. Their smooth leather upper has all the signature Samba details you know and love, like the T-toe and serrated 3-Stripes. The gum rubber outsole forever pays tribute to the Samba's football heritage.
            </p>
